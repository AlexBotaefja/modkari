...
client.on("message", async message => {
  ...
  if (message.content.match(prefixMention)) {
    ...
    let embed = new MessageEmbed()
        ...
        :question: Still need help? [Click Here](https://discord.gg/NxsQnCdjTg) to join server
        `)
...
client.on("ready", () => {
   client.user.setActivity(`>help para ver mis comandos`); // You can change it to online, dnd, idle
...
client.login("OTYyNjU3NjU4MTYxMjI1NzU4.GQ6uQD.3vuO-9i249dXsg_uz1DjRXka-G4QgmSgH5MiHc");
